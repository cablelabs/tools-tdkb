...
class CosaMTA : public RDKTestStubInterface, public AbstractServer<CosaMTA>
{
	public:
        ...
        CosaMTA(TcpSocketServer &ptrRpcServer) : AbstractServer <CosaMTA>(ptrRpcServer)
		{
			...
			this->bindAndAddMethod(Procedure("CosaMTA_DectGetEnable", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "boolValue", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_DectGetEnable);
			this->bindAndAddMethod(Procedure("CosaMTA_DectSetEnable", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "boolValue", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_DectSetEnable);
			this->bindAndAddMethod(Procedure("CosaMTA_DectGetRegistrationMode", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "boolValue", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_DectGetRegistrationMode);
			this->bindAndAddMethod(Procedure("CosaMTA_DectSetRegistrationMode", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "boolValue", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_DectSetRegistrationMode);
			...
			this->bindAndAddMethod(Procedure("CosaMTA_GetDSXLogEnable", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "boolValue", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_GetDSXLogEnable);
			this->bindAndAddMethod(Procedure("CosaMTA_SetDSXLogEnable", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "boolValue", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_SetDSXLogEnable);
			this->bindAndAddMethod(Procedure("CosaMTA_ClearDSXLog", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "boolValue", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_ClearDSXLog);
			this->bindAndAddMethod(Procedure("CosaMTA_GetCallSignallingLogEnable", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "boolValue", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_GetCallSignallingLogEnable);
			...
			this->bindAndAddMethod(Procedure("CosaMTA_ClearCallSignallingLog", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "boolValue", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_ClearCallSignallingLog);
