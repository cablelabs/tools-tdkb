...
puts {
#####################################################################################
TESTCASEID : TC_ERTR_0249
Description  :Verify that http traffic between WLan to LAN should be denied, 
when wifi client assocation in wpa2-psk authentication for 5GHZ and SSID interface 
parameter for 5GHZ [Device.WiFi.SSID.2.Enable] is disabled.
#####################################################################################
}
