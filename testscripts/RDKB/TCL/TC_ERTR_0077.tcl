...
puts {
##########################################################################################################################################
#TEST CASEID :TC_ERTR_0077                                                                                                                                                                            
#Description  :Verify that when Firewall Config is set to Medium, HTTP traffic from WLAN to WAN should pass through
##########################################################################################################################################
}
...
if {[regexp {.*200 OK.*} $outHttp match] == 1} {
        ...
        puts "HTTP traffic successful from WLAN to WAN when Firewall is set to Medium"
                } else {
