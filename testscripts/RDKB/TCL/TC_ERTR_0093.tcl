...
puts {
######################################################################################################################### 
#TESTCASE ID: TC_ERTR_0093
#Description  :Verify DMZ with FTP service running on Wi-Fi Client and Firewall mode set to Low, 
...
puts {
##########################################################################################################
#Step 2 :Setting the firewall to Low mode and enable DMZ
##########################################################################################################
}
set voutput1 "";
...
if {[regexp {.*230.*} $outFtp match] == 1} {
        ...
        puts "FTP Request successful from WAN to WLAN when firewall is set to Low and DMZ is enabled." 
                } else {
