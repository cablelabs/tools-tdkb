...
puts {
#########################################################################################################################
#TESTCASEID : TC_ERTR_0171
#Description  :Verify that MAC address of 5 GHz radio band obtained through parameter (Device.WiFi.SSID.2.BSSID) matches 
...
set response [device_set_get_param $ClassPath $Class $oui $SNno $deviceType GetParameterValue Device.WiFi.SSID.$si5.BSSID null null {rType output}];
