...
puts {
##########################################################################################################################################
#TEST CASEID :TC_ERTR_0391                                                                                                  
#Description  :Verify that WG allows other websites except for the sites that has been blocked using URL
...
puts {
################################################################################
#Step 3 :Telnet to Ethernet client and trying to access other unblocked sites                                       
################################################################################
}
...
if {[regexp {.*200 OK.*} $outHttps match] == 1} {
        ...
        puts "The other Websites, Ex:'$siteHttps' can be reached."
                } else {
        set failFlag [expr $failFlag + 1];
        puts "The Other websites Ex.'$siteHttps' cannot be reached."
}
