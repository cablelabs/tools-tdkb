...
puts {
######################################################################################################################### 
#TESTCASE ID: TC_ERTR_0090
#Description  :Verify DMZ with FTP service running on Wi-Fi Client and Firewall mode set to Medium, FTP access should be successful from WAN to WLAN
#########################################################################################################################
} 
...
puts {
##########################################################################################################
#Step 1 :Setting the firewall to Medium and enable DMZ
##########################################################################################################
}
set voutput1 "";
...
if {[regexp {.*230.*} $outFtp match] == 1} {
        ...
        puts "FTP Request successful from WAN to WLAN when firewall is set to Medium and DMZ is enabled." 
                } else {
