...
TESTCASEID : TC_ERTR_0146 to  TC_ERTR_0151																							    
...
if {[regexp -nocase {TC_ERTR_0146} $logical_id]} {
...
} elseif {[regexp -nocase {TC_ERTR_0147} $logical_id]} {
...
} elseif {[regexp -nocase {TC_ERTR_0148} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si2.Security.ModeEnabled";
...
} elseif {[regexp -nocase {TC_ERTR_0149} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si5.Security.ModeEnabled";
...
} elseif {[regexp -nocase {TC_ERTR_0150} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si2.Security.ModeEnabled";
set profileType "Wireless.xml";
...
} elseif {[regexp -nocase {TC_ERTR_0151} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si5.Security.ModeEnabled";
set profileType "Wireless-5GHz.xml";
set wlan_sec_type "wpawpa2-psk";
set ssidName "$ssid5";
...
set result "FAILED";
puts "FTP access not successful between two ethernet clients";
}
".*ftp>"
{
send "bye\r";
