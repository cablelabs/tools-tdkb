...
puts { 
########################################################################################################################################## 
#TEST CASEID :TC_ERTR_0122                                                                                                   #Description  :Verify that WG allows other websites except for the sites that has been blocked using keyword (google) through Parental control (managed sites) 
########################################################################################################################################## 
}  
...
puts { 
################################################################################ 
#Step 5 :Telneting to WLAN Client and trying to access the unblocked Keyword
################################################################################ 
} 
...
if {[regexp {.*200 OK.*} $outHttps match] == 1} { 
        ...
        puts "The unblocked keyword can be reached." 
                } else { 
        set failFlag [expr $failFlag + 1];  
        puts "The unblocked keyword cannot be reached." 
}
