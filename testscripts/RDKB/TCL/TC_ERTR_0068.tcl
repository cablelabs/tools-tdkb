...
puts {
##########################################################################################################################################
#TEST CASEID :TC_ERTR_0068                                                                                                                                                                            
#Description  :Verify that when Firewall Config is set to High, HTTPS  access from WLAN to WAN should pass through
##########################################################################################################################################
}
...
if {[regexp {.*200 OK.*} $outHttps match] == 1} {
        ...
        puts "HTTPS traffic successful from WLAN to WAN when Firewall is set to High"
                } else {
