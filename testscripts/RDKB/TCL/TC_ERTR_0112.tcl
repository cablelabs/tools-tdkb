...
puts { 
########################################################################################################################################## 
#TEST CASEID :TC_ERTR_0112
#Description  :Verify that WG supports blocking of FTP service for Wi-Fi Client associated using 2.4GHZ radio only during specific day and time period through parental control (managed services)
########################################################################################################################################## 
} 
