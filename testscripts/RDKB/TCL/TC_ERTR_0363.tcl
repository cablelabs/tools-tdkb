...
puts {
#####################################################################################
TESTCASEID : TC_ERTR_0363
Description  : Verify that FTP traffic between WLAN to LAN should be denied, 
when wifi client assocation in open authentication for 2.4GHZ and Radio interface 
...
puts {
################################################################################
#Step 5 :Telnet to LAN Client and send FTP request to WLAN Client
################################################################################
}
spawn telnet $Telnetip $telnetPort1;
set timeout 100;
...
set result "PASSED"
  ...
  puts {
############################################################################################
#Step 6 :Deleting the created profile.
############################################################################################
}
