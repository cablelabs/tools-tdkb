...
puts {
#################################################################################################################################################
#TEST CASEID :TC_ERTR_0173				
#Verify that on configuring DHCP Server Subnet mask to 255.255.0.0, it gets reflected successfully on the Wi-Fi Client connected via 2.4GHz radio
##################################################################################################################################################
}
