...
puts {
######################################################################################################################### 
#TEST CASEID :TC_ERTR_0094								
#Description  :Verify that on configuring DHCP Server to Class A Private IP range (10.x.x.x - 10.255.255.255), Wi-Fi Client
# connected via 2.4GHz radio successfully receives IP address
#########################################################################################################################
}
...
puts {
################################################################################
#Step 1 :Set DHCP server pool with Class A private IP address range
################################################################################
}
