...
puts {
#####################################################################################
TESTCASEID : TC_ERTR_0359
Description  :Verify that HTTP traffic between WLAN to LAN should be denied, when wifi 
client assocation in wpa2-psk authentication for 2.4GHZ and Radio interface parameter 
for 2.4GHZ [Device.WiFi.Radio.1.Enable] is disabled.
#####################################################################################
}
...
puts {
##########################################################################################################
#Step 4 :Disabling 2.4GHz radio interface of the WG
##########################################################################################################
}
set device_param "Device.WiFi.Radio.$ri2.Enable";
set value "false";
