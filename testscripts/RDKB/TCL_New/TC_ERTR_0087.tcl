...
puts {
######################################################################################################################### 
#TEST CASE ID :TC_ERTR_0087										
#Description : Verify Port Forwarding with FTP service running on Wi-Fi Client and Firewall mode set to Low, 
...
if {[regexp {.*230.*} $outFtp match] == 1} {
        ...
        puts "FTP Request successful from WAN to WLAN when firewall is set to Low and Port Forwarding is enabled."
                } else {
