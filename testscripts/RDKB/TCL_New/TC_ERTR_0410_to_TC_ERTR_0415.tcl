...
puts {
#####################################################################################				
TESTCASEID : TC_ERTR_0410 to TC_ERTR_0415																							    
...
if {[regexp -nocase {TC_ERTR_0410} $logical_id]} {
...
} elseif {[regexp -nocase {TC_ERTR_0411} $logical_id]} {
...
} elseif {[regexp -nocase {TC_ERTR_0412} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si2.Security.ModeEnabled";
...
} elseif {[regexp -nocase {TC_ERTR_0413} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si5.Security.ModeEnabled";
...
} elseif {[regexp -nocase {TC_ERTR_0414} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si2.Security.ModeEnabled";
set profileType "Wireless.xml";
...
} elseif {[regexp -nocase {TC_ERTR_0415} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si5.Security.ModeEnabled";
set profileType "Wireless-5GHz.xml";
set wlan_sec_type "wpawpa2-psk";
set ssidName "$ssid5";
