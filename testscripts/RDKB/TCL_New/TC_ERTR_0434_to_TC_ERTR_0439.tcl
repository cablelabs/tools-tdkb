...
TESTCASEID : TC_ERTR_0434 to TC_ERTR_0439																							    
Description : Verify that UDP Traffic should be successfull with destination as 
              wired client and source as wireless client with firewall set to High.  
...
if {[regexp -nocase {TC_ERTR_0434} $logical_id]} {
...
TESTCASEID : TC_ERTR_0434                                                                                    
Description : Verify that UDP Traffic should be successfull with destination as
              wired client and source as wireless client  where client association 
              in open security wlan on 2.4ghz band with firewall set to High.

#####################################################################################
 }

} elseif {[regexp -nocase {TC_ERTR_0435} $logical_id]} {
...
TESTCASEID : TC_ERTR_0435
Description : Verify that UDP Traffic should be successfull with destination as
              wired client and source as wireless client  where client association
              in open security wlan on 5ghz band with firewall set to High.

#####################################################################################
 }


} elseif {[regexp -nocase {TC_ERTR_0436} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si2.Security.ModeEnabled";
...
TESTCASEID : TC_ERTR_0436
Description : Verify that UDP Traffic should be successfull with destination as
              wired client and source as wireless client  where client association
              in wpa2-psk security wlan on 2.4ghz band with firewall set to High.

#####################################################################################
 }


} elseif {[regexp -nocase {TC_ERTR_0437} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si5.Security.ModeEnabled";
...
TESTCASEID : TC_ERTR_0437
Description : Verify that UDP Traffic should be successfull with destination as
              wired client and source as wireless client  where client association
              in wpa2-psk security wlan on 5ghz band with firewall set to High.

#####################################################################################
 }


} elseif {[regexp -nocase {TC_ERTR_0438} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si2.Security.ModeEnabled";
set profileType "Wireless.xml";
...
TESTCASEID : TC_ERTR_0438
Description : Verify that UDP Traffic should be successfull with destination as
              wired client and source as wireless client  where client association
              in wpawpa2-psk security wlan on 2.4ghz band with firewall set to High.

#####################################################################################
 }


} elseif {[regexp -nocase {TC_ERTR_0439} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si5.Security.ModeEnabled";
set profileType "Wireless-5GHz.xml";
set wlan_sec_type "wpawpa2-psk";
set ssidName "$ssid5";
...
TESTCASEID : TC_ERTR_0439
Description : Verify that UDP Traffic should be successfull with destination as
              wired client and source as wireless client  where client association
              in wpawpa2-psk security wlan on 5ghz band with firewall set to High.
...
puts {
################################################################################
#Step  : Configuring the firewall sets to High
################################################################################
}
...
###############################################################################
#step 3: Telnet to LAN Client and get its ip address
###############################################################################
sleep 30;
