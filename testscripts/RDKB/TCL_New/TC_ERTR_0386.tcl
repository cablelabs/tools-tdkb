...
puts {
#####################################################################################
TESTCASEID : TC_ERTR_0386
Description  : Verify that ftp traffic between WLAN to LAN should be denied, 
when wifi client assocation in open authentication for 5GHZ and SSID interface 
...
puts {
################################################################################
#Step 5 :Trying to Telnet to LAN Client and try FTP access
################################################################################
}
spawn telnet $Telnetip $telnetPort1;
set timeout 100;
