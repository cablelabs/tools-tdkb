...
puts {
#####################################################################################				
TESTCASEID : TC_ERTR_0404 to TC_ERTR_0409									
...
if {[regexp -nocase {TC_ERTR_0404} $logical_id]} {
...
} elseif {[regexp -nocase {TC_ERTR_0405} $logical_id]} {
...
} elseif {[regexp -nocase {TC_ERTR_0406} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si2.Security.ModeEnabled";
...
} elseif {[regexp -nocase {TC_ERTR_0407} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si5.Security.ModeEnabled";
...
} elseif {[regexp -nocase {TC_ERTR_0408} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si2.Security.ModeEnabled";
set profileType "Wireless.xml";
...
} elseif {[regexp -nocase {TC_ERTR_0409} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si5.Security.ModeEnabled";
set profileType "Wireless-5GHz.xml";
set wlan_sec_type "wpawpa2-psk";
set ssidName "$ssid5";
