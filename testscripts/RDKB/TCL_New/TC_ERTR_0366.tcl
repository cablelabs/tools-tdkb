...
puts {
#####################################################################################
TESTCASEID : TC_ERTR_0366
Description  :Verify that HTTPs traffic between WLAN to LAN should be denied, when 
wifi client assocation in wpa2-psk authentication for 2.4GHZ and ssid interface 
...
puts {
##########################################################################################################
#Step 4 :Disabling 2.4GHz SSID interface of the WG
##########################################################################################################
}
set device_param "Device.WiFi.SSID.$si2.Enable";
set value "false";
