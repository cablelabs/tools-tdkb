...
TESTCASEID : TC_ERTR_0446 to TC_ERTR_0451																							    
...
if {[regexp -nocase {TC_ERTR_0446} $logical_id]} {
...
} elseif {[regexp -nocase {TC_ERTR_0447} $logical_id]} {
...
} elseif {[regexp -nocase {TC_ERTR_0448} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si2.Security.ModeEnabled";
...
} elseif {[regexp -nocase {TC_ERTR_0449} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si5.Security.ModeEnabled";
...
} elseif {[regexp -nocase {TC_ERTR_0450} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si2.Security.ModeEnabled";
set profileType "Wireless.xml";
...
} elseif {[regexp -nocase {TC_ERTR_0451} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si5.Security.ModeEnabled";
set profileType "Wireless-5GHz.xml";
set wlan_sec_type "wpawpa2-psk";
set ssidName "$ssid5";
