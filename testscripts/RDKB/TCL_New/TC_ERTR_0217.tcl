...
puts {
#####################################################################################
TESTCASEID : TC_ERTR_0217
Description  :Verify that telnet traffic between wireless and wired clients should 
be denied when Radio interface parameter for 2.4GHZ [Device.WiFi.Radio.1.Enable] 
is disabled.
#####################################################################################
}
