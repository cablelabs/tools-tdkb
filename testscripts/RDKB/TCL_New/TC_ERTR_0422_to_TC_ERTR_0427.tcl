...
puts {
#####################################################################################				
TESTCASEID : TC_ERTR_0422 to TC_ERTR_0427																							    
Description : Verify that TCP Traffic should be successfull with destination as 
              wired client and source as wireless client with firewall set to Medium           
#####################################################################################
 }
...
if {[regexp -nocase {TC_ERTR_0422} $logical_id]} {
...
TESTCASEID : TC_ERTR_0422                                                                                    
Description : Verify that TCP Traffic should be successfull with destination as
              wired client and source as wireless client  where client association 
              in open security wlan on 2.4ghz band with firewall set to Medium.

#####################################################################################
 }

} elseif {[regexp -nocase {TC_ERTR_0423} $logical_id]} {
...
TESTCASEID : TC_ERTR_0423
Description : Verify that TCP Traffic should be successfull with destination as
              wired client and source as wireless client  where client association
              in open security wlan on 5ghz band with firewall set to Medium.

#####################################################################################
 }


} elseif {[regexp -nocase {TC_ERTR_0424} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si2.Security.ModeEnabled";
...
TESTCASEID : TC_ERTR_0424
Description : Verify that TCP Traffic should be successfull with destination as
              wired client and source as wireless client  where client association
              in wpa2-psk security wlan on 2.4ghz band with firewall set to Medium.

#####################################################################################
 }


} elseif {[regexp -nocase {TC_ERTR_0425} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si5.Security.ModeEnabled";
...
TESTCASEID : TC_ERTR_0425
Description : Verify that TCP Traffic should be successfull with destination as
              wired client and source as wireless client  where client association
              in wpa2-psk security wlan on 5ghz band with firewall set to Medium.

#####################################################################################
 }


} elseif {[regexp -nocase {TC_ERTR_0426} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si2.Security.ModeEnabled";
set profileType "Wireless.xml";
...
TESTCASEID : TC_ERTR_0426
Description : Verify that TCP Traffic should be successfull with destination as
              wired client and source as wireless client  where client association
              in wpawpa2-psk security wlan on 2.4ghz band with firewall set to Medium.

#####################################################################################
 }


} elseif {[regexp -nocase {TC_ERTR_0427} $logical_id]} {
set device_param "Device.WiFi.AccessPoint.$si5.Security.ModeEnabled";
set profileType "Wireless-5GHz.xml";
set wlan_sec_type "wpawpa2-psk";
set ssidName "$ssid5";
...
TESTCASEID : TC_ERTR_0427
Description : Verify that TCP Traffic should be successfull with destination as
              wired client and source as wireless client  where client association
              in wpawpa2-psk security wlan on 5ghz band with firewall set to Medium.
...
puts {
################################################################################
#Step  : Configuring the firewall sets to Medium
################################################################################
}
...
puts {
#########################################################################################################
#Step 2 :Trying to Telnet to WLAN server and associate wirelessly for open security                                     
#########################################################################################################
}
