...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To check whether the current moca version is 2.0 for standalone setup.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To check whether the current moca version is 2.0 for standalone setup.</test_objective>
