...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check whether device supports rebooting via snmp</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To check if the device reboots via snmpset</test_objective>
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	expectedresult="SUCCESS";
        ...
        if expectedresult in actualresult and string in details:
            #Set the result status of execution
            tdkTestObj.setResultStatus("SUCCESS");
            print "TEST STEP 2: Find if erouter is resetted through logs";
            print "EXPECTED RESULT 2: erouter must reset";
