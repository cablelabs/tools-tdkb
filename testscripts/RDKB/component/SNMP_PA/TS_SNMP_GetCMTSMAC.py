...
OID : 1.3.6.1.2.1.10.127.1.2.1.1.1.2
 ...
 "arp -a | grep erouter0 | grep -v incomplete | cut -d \" \" -f4 | tr \"\n\" \" \" | tr \":\" \" \""</input_parameters>
...
4. Get CMTS MAC using executecmd and compare with snmpget output
...
if "SUCCESS" in loadmodulestatus1.upper() and "SUCCESS" in loadmodulestatus2.upper():
    ...
    if "SNMPv2-SMI" in actResponse:
        ...
        print "ACTUAL RESULT 1: CMTS mac is %s" %mac;
	...
	if expectedresult in actualresult and details:
	    print "TEST STEP 1:Execute arp -a for CMTS mac";
	    print "EXPECTED RESULT 1: arp -a should return CMTS mac";
    	    if mac==details:
	        print "ACTUAL RESULT 1: CMTS MAC from snmpget and arp are same"
		tdkTestObj.setResultStatus("SUCCESS");
	    else:
		print "ACTUAL RESULT 1: CMTS MAC from snmpget and arp are not same"
	    ...
	    tdkTestObj.setResultStatus("FAILURE");
            print "TEST STEP 1:Execute arp -a for CMTS mac";
            print "EXPECTED RESULT 1: arp -a should return CMTS mac";
	    print "ACTUAL RESULT 1: Couldn't get CMTS MAC from arp"	
    else:
        tdkTestObj.setResultStatus("FAILURE");
