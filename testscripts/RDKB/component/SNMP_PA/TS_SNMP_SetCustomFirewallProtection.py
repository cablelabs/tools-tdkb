...
if "SUCCESS" in loadmodulestatus.upper():
	...
	print "snmpset to set the firewall protection as custom"
        actResponse =snmplib.SnmpExecuteCmd(tdkTestObj, "snmpset", "-v 2c", "1.3.6.1.4.1.17270.50.2.4.1.1.0 i 4", ip);
        sleep(5);
        actResponse =snmplib.SnmpExecuteCmd(tdkTestObj, "snmpget", "-v 2c", "1.3.6.1.4.1.17270.50.2.4.1.1.0", ip);
	    ...
	    actResponse =snmplib.SnmpExecuteCmd(tdkTestObj, "snmpset", "-v 2c", "1.3.6.1.4.1.17270.50.2.4.8.0 i 1", ip);
	    sleep(5);
            actResponse =snmplib.SnmpExecuteCmd(tdkTestObj, "snmpget", "-v 2c", "1.3.6.1.4.1.17270.50.2.4.8.0", ip);
            act_value=actResponse.rsplit(None, 1)[-1];
	...
	actResponse =snmplib.SnmpExecuteCmd(tdkTestObj, "snmpset", "-v 2c", "1.3.6.1.4.1.17270.50.2.4.1.1.0 i %s" %org_value, ip);
	sleep(5);
        actResponse =snmplib.SnmpExecuteCmd(tdkTestObj, "snmpget", "-v 2c", "1.3.6.1.4.1.17270.50.2.4.1.1.0", ip);
        act_value=actResponse.rsplit(None, 1)[-1];
