...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>This test case is to get the PrimaryLANBridge</synopsis>
  <groups_id/>
...
4.From python script, invoke COSAPAM_DmlMlanGetParamValue() stub function with parameter PrimaryLANBridge  . 
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("MethodName","PrimaryLANBridge");
    ...
    if expectedresult in actualresult:
        ...
        print "TEST STEP 1: Get the PrimaryLANBridge";
        print "EXPECTED RESULT 1: Failure in getting the PrimaryLANBridge";
        print "ACTUAL RESULT 1: PrimaryLANBridge is %s" %details;
