...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <primitive_test_id/>
  <primitive_test_name>COSAPAM_DhcpcGetNumberOfEntries</primitive_test_name>
...
4.From python script, invoke COSAPAM_DhcpcGetNumberOfEntries() stub function to get the number of entries of DHCP client
5.COSAPAM stub function will call the ssp_CosaDmlDhcpcGetNumberOfEntries function in TDK component which in turn will call cosa api CosaDmlDhcpcGetNumberOfEntries() of the PAM Agent in RDKB stack.
...
Stub function result should be success and should see corresponding log in the agent console log</except_output>
    ...
    <test_stub_interface>COSAPAM_DhcpcGetNumberOfEntries</test_stub_interface>
    <test_script>TS_COSAPAM_DhcpcNumberOfEntries</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
