...
4.From python script, invoke COSAPAM_DhcpsGetState() stub function to get the state of DHCP server
5.COSAPAM stub function will call the ssp_CosaDmlDhcpsGetState function in TDK component which in turn will call cosa api CosaDmlDhcpsGetState() of the PAM Agent in RDKB stack.
...
Stub function result should be success and should see corresponding log in the agent console log</except_output>
    ...
    <test_stub_interface>COSAPAM_DhcpsGetState</test_stub_interface>
