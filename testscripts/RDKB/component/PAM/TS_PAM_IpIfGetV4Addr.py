...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>TC_PAM_72</test_case_id>
    <test_objective>To get the IPV4 address</test_objective>
...
Input:
ParamName - Device.IP.Interface.1.IPv4Address.1.</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page. 
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_GetParameterValues() stub function to get the IPV4 address.
...
8.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from pam stub.</automation_approch>
 ...
 The IPV4 address should be logged in the Agent console/Component log
