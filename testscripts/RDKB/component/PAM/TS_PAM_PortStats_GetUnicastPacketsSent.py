...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        tdkTestObj.addParameter("paramName","UnicastPacketsSent");
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP 1: Retrieve the Port statistic information on the number of unicast packets sent";
            print "EXPECTED RESULT 1: Should retrieve the Port statistic information on the number of unicast  packets sent successfully";
