...
4.From python script, invoke COSAPAM_TUpnpDevGetMediaServerState() stub function to get UPNP dev MediaServer status
5.COSAPAM stub function will call the ssp_CosaDmlUpnpDevGetMediaServerState function in TDK component which in turn will call cosa api CosaDmlUpnpDevGetMediaServerState() of the PAM Agent in RDKB stack.
...
Stub function result should be success and should see corresponding log in the agent console log</except_output>
    ...
    <test_stub_interface>COSAPAM_UpnpDevGetMediaServerState</test_stub_interface>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        print "EXPECTED RESULT 1: Should set the UpnpDev Media Server enable successfully";
