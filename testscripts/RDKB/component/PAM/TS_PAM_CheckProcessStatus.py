...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("command", "/fss/gw/usr/ccsp/ccsp_bus_client_tool %s getvalues Device.DeviceInfo.ProcessStatus.Process. | grep -A 10 $(pidof tdk_agent) | grep -A 1 State | cut -f3 -d ':' | tr \"\n\" \" \""%prefix);
