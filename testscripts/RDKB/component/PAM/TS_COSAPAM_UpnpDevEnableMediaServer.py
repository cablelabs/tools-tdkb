...
4.From python script, invoke COSAPAM_UpnpDevEnableMediaServer() stub function to set UPNP MediaServer enable
5.COSAPAM stub function will call the ssp_CosaDmlUpnpDevEnableMediaServer function in TDK component which in turn will call cosa api CosaDmlUpnpDevEnableMediaServer() of the PAM Agent in RDKB stack.
...
Stub function result should be success and should see corresponding log in the agent console log</except_output>
    ...
    <test_stub_interface>COSAPAM_UpnpDevEnableMediaServer</test_stub_interface>
