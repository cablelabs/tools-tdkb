...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>CosaDmlIpDnsGetRelayStatus</api_or_interface_used>
...
4.From python script, invoke COSAPAM_IpDnsGetRelayStatus() stub function to get the DNS Relay status
5.COSAPAM stub function will call the ssp_CosaDmlIpDnsGetRelayStatus function in TDK component which in turn will call cosa api CosaDmlIIpDnsGetRelayStatus() of the PAM Agent in RDKB stack.
...
Stub function result should be success and should see corresponding log in the agent console log</except_output>
    ...
    <test_stub_interface>COSAPAM_IpDnsGetRelayStatus</test_stub_interface>
