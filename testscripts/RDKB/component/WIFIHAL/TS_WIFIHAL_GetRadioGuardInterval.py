...
<xml>
  ...
  <name>TS_WIFIHAL_GetRadioGuardInterval</name>
...
5. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_GetRadioGuardInterval</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_GetRadioGuardInterval');
