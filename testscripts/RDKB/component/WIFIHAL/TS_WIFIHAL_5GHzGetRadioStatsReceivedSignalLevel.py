...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_5GHzGetRadioStatsReceivedSignalLevel.py)
3.Execute the generated Script(TS_WIFIHAL_5GHzGetRadioStatsReceivedSignalLevel.py) using execution page of  Test Manager GUI
