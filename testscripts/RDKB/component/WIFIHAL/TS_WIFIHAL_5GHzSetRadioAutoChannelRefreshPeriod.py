...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To To set the auto channel refresh period if the automatic channel selection is enabled for 5GHz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
7. getRadioChannel and check if the channe lhas changed after refresh period. If yes, return SUCCESS.
