...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To check the Beacon type value set in device for 5GHz radio using wifi_getApBeaconType HAL API and validate the same</synopsis>
  ...
  <test_cases>
    ...
    <test_objective>To check the Beacon type value set in device for 5GHz radio using wifi_getApBeaconType HAL API and validate the same</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_5GHzGetApBeaconType.py)
3.Execute the generated Script(TS_WIFIHAL_5GHzGetApBeaconType.py) using execution page of  Test Manager GUI
