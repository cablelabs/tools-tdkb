...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script
    ...
    <input_parameters>
methodName : getApSecurityPreSharedKey
apIndex    : 1
    </input_parameters>
    <automation_approch>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_5GHzGetApSecurityPreSharedKey.py)
3.Execute the generated Script(TS_WIFIHAL_5GHzGetApSecurityPreSharedKey.py) using execution page of  Test Manager GUI
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page"""
    ...
    <test_script>TS_WIFIHAL_5GHzGetApSecurityPreSharedKey</test_script>
    <skipped>No</skipped>
