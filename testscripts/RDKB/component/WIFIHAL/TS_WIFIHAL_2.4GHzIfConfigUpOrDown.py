...
def IfConfigDown():
    ...
    if expectedresult in actualresult:
        ...
        print"ACTUAL RESULT:wifi_ifConfigDown() api returned SUCCESS for 2.4GHz";
        print"[TEST EXECUTION RESULT]:SUCCESS";
    else:
        tdkTestObj.setResultStatus("FAILURE");
        print"TEST STEP:To invoke the wifi_ifConfigDown() api for 2.4GHz";
        print"EXPECTED RESULT:wifi_ifConfigDown() api should return SUCCESS for 2.4GHz";
        print"ACTUAL RESULT:wifi_ifConfigDown() api did not returned SUCCESS for 2.4GHz";
...
def IfConfigUp():
    ...
    if expectedresult in actualresult:
        ...
        print"ACTUAL RESULT:wifi_ifConfigUp() api returned SUCCESS for 2.4GHz";
        print"[TEST EXECUTION RESULT]:SUCCESS";
    else:
        tdkTestObj.setResultStatus("FAILURE");
        print"TEST STEP:To invoke the wifi_ifConfigUp() api for 2.4GHz";
        print"EXPECTED RESULT:wifi_ifConfigUp() api should return SUCCESS for 2.4GHz";
        print"ACTUAL RESULT:wifi_ifConfigUp() api did not returned SUCCESS for 2.4GHz";
        print"[TEST EXECUTION RESULT]:FAILURE";
