...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult and OperatingFreqBands.split(":")[1] in ExpectedFreqList:
        ...
        print "TEST STEP 1: Get the Radio Operating Frequency band for 2.4GHz";
        print "EXPECTED RESULT 1: Should get the Radio Operating Frequency band for 2.4GHz";
        print "ACTUAL RESULT 1: %s" %OperatingFreqBands;
        #Get the result of execution
        print "[TEST EXECUTION RESULT] : SUCCESS";
    else:
        #Set the result status of execution
        tdkTestObj.setResultStatus("FAILURE");
        print "TEST STEP 1: Get the Radio Operating Frequency band 2.4GHz";
        print "EXPECTED RESULT 1: Should get the Radio Operating Frequency band 2.4GHz";
        print "ACTUAL RESULT 1: %s" %OperatingFreqBands;
        #Get the result of execution
