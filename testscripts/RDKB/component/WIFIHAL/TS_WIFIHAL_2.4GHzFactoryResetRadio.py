...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To invoke the api wifi_factoryResetRadio() for 2.4GHz and check whether the set and get values are different after doing factory reset radio.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To invoke the api wifi_factoryResetRadio() for 2.4GHz and check whether the set and get values are different after factory reset.</test_objective>
...
8.Unload the module.</automation_approch>
    <except_output>The set and get values should be different doing  after factory reset by invoking wifi_factoryResetRadio() for 2.4GHz.</except_output>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    InvokeGetSetMethod('WIFIHAL_GetOrSetParamULongValue',int(9),"setRadioChannel");
    time.sleep(5);
	...
	if RadioChannel != int(9):
	    tdkTestObj.setResultStatus("SUCCESS");
            print"TEST STEP1:To invoke wifi_factoryResetRadio() api and check whether the RadioChannel is not equal to the set value for 2.4GHz";
	    print"EXPECTED RESULT1:RadioChannel should not be equal to the set value for 2.4GHz";
	    print"ACTUAL RESULT1:RadioChannel is not equal to set value for 2.4GHz";
	    print"{TEST EXECUTION RESULT1]:SUCCESS";
        else:
            tdkTestObj.setResultStatus("FAILURE");
            print"TEST STEP1:To invoke wifi_factoryResetRadio() api and check whether RadioChannel is not equal to the set value for 2.4GHz";
	    print"EXPECTED RESULT1::RadioChannel should not be equal to the set value for 2.4GHz";
	    print"ACTUAL RESULT1:RadioChannel is equal to set value for 2.4GHz";
        ...
        if OperatingChannelBandwidth != "20MHz":
            tdkTestObj.setResultStatus("SUCCESS");
            print"TEST STEP2:To invoke wifi_factoryResetRadio() api and check whether the OperatingChannelBandwidth is not equal to the set value for 2.4GHz";
	    print"EXPECTED RESULT2:OperatingChannelBandwidth should not be equal to the set value for 2.4GHz";
	    print"ACTUAL RESULT2:OperatingChannelBandwidth is not equal to the set value for 2.4GHz";
	    print"[TEST EXECUTION RESULT2]:SUCCESS";
        else:
            tdkTestObj.setResultStatus("FAILURE");
            print"TEST STEP2:To invoke wifi_factoryResetRadio() api and check whether the OperatingChannelBandwidth is not equal to the set value for 2.4GHz";
	    print"EXPECTED RESULT2:OperatingChannelBandwidth should not be equal to the set value for 2.4GHz";
	    print"ACTUAL RESULT2:OperatingChannelBandwidth is equal to the set value for 2.4GHz";
        ...
        if GuardInterval != "800nsec" :
            tdkTestObj.setResultStatus("SUCCESS");
            print"TEST STEP3:To invoke wifi_factoryResetRadio() api and check whether the GuardInterval value is not equal to the set value for 2.4GHz";
	    print"EXPECTED RESULT3:GuardInterval value should not be equal to the set value for 2.4GHz";
	    print"ACTUAL RESULT3:GuardInterval value is not equal to the set value for 2.4GHz";
	    print"[TEST EXECUTION RESULT3]:SUCCESS";
        else:
            tdkTestObj.setResultStatus("FAILURE");
            print"TEST STEP3:To invoke wifi_factoryResetRadio() api and check whether the GuardInterval value is not equal to the set value for 2.4GHz";
	    print"EXPECTED RESULT3:GuardInterval value should not be equal to the set value for 2.4GHz";
	    print"ACTUAL RESULT3:GuardInterval value is equal to the set value for 2.4GHz";
