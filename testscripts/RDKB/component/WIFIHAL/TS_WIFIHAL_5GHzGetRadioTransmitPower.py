...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To get the transmit power for 5GHz using wifi_getRadioTransmitPower and validate the same using wifi_getRadioTransmitPowerSupported</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To get the transmit power for 5GHz using wifi_getRadioTransmitPower and validate the same using wifi_getRadioTransmitPowerSupported</test_objective>
...
2. Invoke "WIFIHAL_GetOrSetParamStringValue" to get the Supported radio transmit power for 5GHz
...
2.Should successfully get the current transmit power for 5GHz</except_output>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        print "TEST STEP 1: Get the supported transmit power for 5GHz";
        print "EXPECTED RESULT 1: Should get the supported transmit power for 5GHz";
        ...
        #Giving the method name to invoke the api to get curretn transmit power, wifi_getRadioTransmitPower()
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP 2: Get the current transmit power for 5GHz"
            print "EXPECTED RESULT 2: Should get the current transmit power for 5GHz";
