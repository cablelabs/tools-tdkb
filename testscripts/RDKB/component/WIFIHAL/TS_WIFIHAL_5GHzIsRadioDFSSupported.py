...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_5GHzIsRadioDFSSupported</name>
  <primitive_test_id/>
...
5. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzIsRadioDFSSupported</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzIsRadioDFSSupported');
