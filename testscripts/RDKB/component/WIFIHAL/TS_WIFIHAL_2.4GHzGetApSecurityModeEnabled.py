...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To check the access point Security mode enabled for 2.4GHz radio using  wifi_getApSecurityModeEnabled HAL API and validate the same</synopsis>
  ...
  <test_cases>
    ...
    <test_objective>To check if Access point Security mode enabled for 2.4GHz radio using  wifi_getApSecurityModeEnabled HAL API and validate the same</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_2.4GHzGetApSecurityModeEnabled.py)
3.Execute the generated Script(TS_WIFIHAL_2.4GHzGetApSecurityModeEnabled.py) using execution page of  Test Manager GUI
