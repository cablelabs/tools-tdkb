...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To set the upstream Channel ID using the api docsis_SetUSChannelId()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To set the upstream Channel ID using the api docsis_SetUSChannelId()</test_objective>
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	print "The US Channel ID to set is %d" %setValue;
	    ...
	    tdkTestObj = obj.createTestStep("CMHAL_GetParamUlongValue");
    	    ...
    	    if expectedresult in actualresult and setValue == int(USChannelID1):
    	        #Set the result status of execution
    	        tdkTestObj.setResultStatus("SUCCESS");
