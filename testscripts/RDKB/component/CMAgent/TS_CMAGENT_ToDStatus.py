...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>TC_CMAGENT_20 - To Validate "ToDStatus" Function Parameter</synopsis>
...
( eg: "Device.X_CISCO_COM_CableModem.ToDStatus" )</input_parameters>
    <automation_approch>1.Configure the Function info in Test Manager GUI  which needs to be tested  
(CMAgent_Get  - func name - "If not exists already"
 cmagent - module name
 Necessary I/P args as Mentioned in Input)
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_CMAGENT_ToDStatus.py)
3.Execute the generated Script(TS_CMAGENT_ToDStatus.py) using excution page of  Test Manager GUI
...
if expectedresult in actualresult:
	...
	tdkTestObj.setResultStatus("SUCCESS");
        print "Get Value of ToD Status Function is SUCCESS"
else:
	#Set the result status of execution as failure
	tdkTestObj.setResultStatus("FAILURE");
        print "Get Value of ToD Status Function is FAILURE"
