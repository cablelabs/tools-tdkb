...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_SetRadioEnable</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_41</test_case_id>
...
2. Using WIFIHal_CallMethodForBool invoke wifi_getRadioEnable and save the current radio enable state
3.Using WIFIHal_CallMethodForBool invoke wifi_setRadioEnable and toggle the current radio enable state
...
6. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_SetRadioEnable</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_SetRadioEnable');
