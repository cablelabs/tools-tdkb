...
<xml>
  ...
  <name>TS_WIFIHAL_getRadioMCS</name>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</automation_approch>
    <except_output>1. Load wifiagent module
...
5.Unload wifiagent module</except_output>
    <priority>High</priority>
    <test_stub_interface>WiFiAgent</test_stub_interface>
    <test_script>TS_WIFIHAL_getRadioMCS</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_getRadioMCS');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    primitive = 'WIFIHal_CallMethodForInt'
