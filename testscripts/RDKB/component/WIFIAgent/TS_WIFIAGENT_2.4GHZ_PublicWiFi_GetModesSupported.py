...
<xml>
  ...
  <test_cases>
    ...
    <test_objective>Get Device.WiFi.AccessPoint.5.Security.ModesSupported and check whether it is None only</test_objective>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult and Mode == "None":
        tdkTestObj.setResultStatus("SUCCESS");
        print "TEST STEP 3: Get the modes supported";
        print "EXPECTED RESULT 3: Should get the Mode supported as None";
