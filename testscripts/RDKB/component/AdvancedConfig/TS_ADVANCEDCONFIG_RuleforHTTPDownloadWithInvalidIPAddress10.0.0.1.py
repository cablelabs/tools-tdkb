...
3.Execute the generated Script(TS_ADVANCEDCONFIG_RuleforHTTPDownloadWithInvalidIPAddress10.0.0.1.py) using execution page of  Test Manager GUI
...
TestManager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_ADVANCEDCONFIG_RuleforHTTPDownloadWithInvalidIPAddress10.0.0.1</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
