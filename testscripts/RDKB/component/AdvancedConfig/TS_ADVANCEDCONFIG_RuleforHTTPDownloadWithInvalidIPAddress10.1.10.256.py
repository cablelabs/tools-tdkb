...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>7</version>
  <name>TS_ADVANCEDCONFIG_RuleforHTTPDownloadWithInvalidIPAddress10.1.10.256</name>
  <primitive_test_id/>
  ...
  <test_cases>
    ...
    <test_objective>To verify, WEB ADMIN:  LAN CPE:  Rule for HTTP  Download  with  invalid  IP  Address 10.1.10.256</test_objective>
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_ADVANCEDCONFIG_RuleforHTTPDownloadWithInvalidIPAddress10.1.10.256.py)
3.Execute the generated Script(TS_ADVANCEDCONFIG_RuleforHTTPDownloadWithInvalidIPAddress10.1.10.256.py) using execution page of  Test Manager GUI
...
Check if "WEB ADMIN:  LAN CPE:  Rule for HTTP  Download  with  invalid  IP  Address 10.1.10.256" functionality works.
CheckPoint 2:
...
TestManager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_ADVANCEDCONFIG_RuleforHTTPDownloadWithInvalidIPAddress10.1.10.256</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ADVANCEDCONFIG_RuleforHTTPDownloadWithInvalidIPAddress10.1.10.256');
...
if "SUCCESS" in loadModuleresult.upper():
        ...
        if expectedresult in actualresult:
                ...
                #Set the result status of execution
                        ...
                        print "[TEST EXECUTION RESULT] : %s" %actualresult;
                        print "New portforwarding table is added\n"
                                        ...
                                        if expectedresult in actualresult:
                                            ...
                                            if expectedresult in actualresult:
                                                ...
                                                if expectedresult in actualresult:
                                                        ...
                                                        tdkTestObj.addParameter("paramValue","10.1.10.256");
                                                        tdkTestObj.addParameter("paramType","string");
                                                        expectedresult="SUCCESS";
                                                        tdkTestObj.executeTestCase(expectedresult);
                                                        actualresult = tdkTestObj.getResult();
                                                        if expectedresult in actualresult:
                                                                ...
                                                                #Get the result of execution
                                                                print "[TEST EXECUTION RESULT] : %s" %actualresult;
                                                                print "IP address is set to 10.1.0.256 \n"
