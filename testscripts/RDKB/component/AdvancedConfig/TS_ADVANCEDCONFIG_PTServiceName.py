...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_ADVANCEDCONFIG_PTServiceName.py)
3.Execute the generated Script(TS_ADVANCEDCONFIG_PTServiceName.py) using execution page of  Test Manager GUI
...
TestManager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_ADVANCEDCONFIG_PTServiceName</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
