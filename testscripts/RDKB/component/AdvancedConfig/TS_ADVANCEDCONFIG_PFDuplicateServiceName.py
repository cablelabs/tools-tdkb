        ...
        if expectedresult in actualresult:
			...
			details = tdkTestObj.getResultDetails();
                        ...
                        if (instance1>0):
                            ...
                            tdkTestObj.addParameter("paramList","Device.NAT.PortMapping.%s.ExternalPort|21|unsignedint|Device.NAT.PortMapping.%s.InternalPort|1|unsignedint|Device.NAT.PortMapping.%s.Protocol|UDP|string|Device.NAT.PortMapping.%s.InternalClient|10.0.0.7|string|Device.NAT.PortMapping.%s.Description|NEW_RULE|string|Device.NAT.PortMapping.%s.ExternalPortEndRange|21|unsignedint|Device.NAT.PortMapping.%s.Enable|true|bool" %(instance1, instance1, instance1, instance1, instance1, instance1, instance1));
                            expectedresult="SUCCESS";
                            tdkTestObj.executeTestCase(expectedresult);
                            actualresult = tdkTestObj.getResult();
                            if expectedresult in actualresult:
                                ...
                                if expectedresult in actualresult:
                                    ...
                                    tdkTestObj = obj.createTestStep("AdvancedConfig_SetMultiple");
                                    tdkTestObj.addParameter("paramList","Device.NAT.PortMapping.%s.ExternalPort|22|unsignedint|Device.NAT.PortMapping.%s.InternalPort|5|unsignedint|Device.NAT.PortMapping.%s.Protocol|UDP|string|Device.NAT.PortMapping.%s.InternalClient|10.0.0.7|string|Device.NAT.PortMapping.%s.Description|NEW_RULE|string|Device.NAT.PortMapping.%s.ExternalPortEndRange|31|unsignedint|Device.NAT.PortMapping.%s.Enable|true|bool" %(instance2, instance2, instance2, instance2, instance2, instance2, instance2));
