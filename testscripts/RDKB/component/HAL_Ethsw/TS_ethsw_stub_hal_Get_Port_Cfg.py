...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        Bitrate_List = ["10","100","1000","10000"];
        ...
        while port <= MAX_PORT:
            ...
            if expectedresult in actualresult and details:
                ...
                if duplexMode in DuplexMode_List and bitRate in Bitrate_List:
                    ...
                    print "ACTUAL RESULT %d: DuplexMode = %s: Bitrate = %s" %(port, duplexMode, bitRate);
                ...
                print "TEST STEP %d: Retrieve the Ethsw_Get_Port_Cfg for port %d" %(port, port);
                print "EXPECTED RESULT %d: Should retrieve the Ethsw_Get_Port_Cfg successfully" %port;
                print "ACTUAL RESULT %d: Failed to retrieve the Ethsw_Get_Port_Cfg" %port;
                print "[TEST EXECUTION RESULT] : %s" %actualresult;
                break;
