        ...
        while port <= MAX_PORT:
            ...
            if expectedresult in actualresult and details:
                ...
                if portStatus in PortStatus_List:
                    ...
                    print "TEST STEP %d: Retrieve the Ethsw_Get_Port_Admin_Status for port %d" %(port, port);
                    print "EXPECTED RESULT %d: Should retrieve the Ethsw_Get_Port_Admin_Status successfully" %port;
                    print "ACTUAL RESULT %d: Port status is %s" %(port, portStatus);
                ...
                print "TEST STEP %d: Retrieve the Ethsw_Get_Port_Admin_Status for port %d" %(port, port);
                print "EXPECTED RESULT %d: Should retrieve the Ethsw_Get_Port_Admin_Status successfully" %port;
                print "ACTUAL RESULT %d: Failed to retrieve the Ethsw_Get_Port_Admin_Status" %port;
                print "[TEST EXECUTION RESULT] : %s" %actualresult;
                break;
