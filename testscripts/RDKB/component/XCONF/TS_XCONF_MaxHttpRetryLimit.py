...
if "SUCCESS" in result.upper() :
    ...
    actualresult, propVal = xconfUtilityLib.GetPlatformProperties(obj, "XCONF_OVERRIDE_FILE")
    ...
    ########create a back_up of override file by renaming. Then add an invalid override url
    tdkTestObj = obj.createTestStep('ExecuteCmd');
    tdkTestObj.addParameter("command","mv " + xconfFile + " " + xconfFile + "_bck ; echo " + XCONF_INVALID_URL + " > " + xconfFile)
    ...
    if expectedresult in actualresult:
        ...
        if "SUCCESS" in result:
            ...
            tdkTestObj = obj.createTestStep('ExecuteCmd');
            tdkTestObj.addParameter("command", "sh " + cdnFile + " 0 5 &");
            tdkTestObj.executeTestCase("SUCCESS");
