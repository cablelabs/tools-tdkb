...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in status:
        ...
        GuardInterval = "Device.WiFi.Radio.%s.GuardInterval" %tdkbE2EUtility.ssid_2ghz_index
        ChannelBW = "Device.WiFi.Radio.%s.OperatingChannelBandwidth" %tdkbE2EUtility.ssid_2ghz_index
