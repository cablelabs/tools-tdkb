                    ...
                    if expectedresult in status:
                        ...
                        if wlanIP:
							...
							time.sleep(60);
                                                        ...
                                                        print "TEST STEP 12: Connect to WLAN Client and send HTTPS Request to LAN Client"
                                                        status = verifyNetworkConnectivity(lanIP,"WGET_HTTPS",tdkbE2EUtility.lan_interface,curIPAddress,wlanIP);
